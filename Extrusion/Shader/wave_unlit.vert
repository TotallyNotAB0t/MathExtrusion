...
void main() 
{
	...
	vec3 addpos = vec3(0.0f,sin(ubd.u_time*5.0+(WorldPos.z+WorldPos.x)*4.0f),0.0f)*3.0f;
    gl_Position = ubc.proj * ubc.view * ubo[index_ubo].model * vec4(inPosition+addpos, 1.0);
}